    ...
    return <div>
        <nav className="flex bg-inherit">
            <ul className="flex justify-end text-xs md:text-md lg:text-lg  w-full  pr-3 md:pr-8 lg:pr-16  font-semibold text-zinc-400">
                ...
                <li className="py-3 md:py-5 lg:py-8  px-2 md:px-4 lg:px-7  flex gap-1 hover:cursor-pointer  hover:text-palette" onClick={()=>{window.open("https://drive.google.com/file/d/1tkVk5w8ueL5rjhjiE2ysaX_GvutYCPrv/view?usp=sharing", "_blank")}}>
                    <p>Resume</p>
                    <div>
